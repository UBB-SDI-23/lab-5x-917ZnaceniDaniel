...
export const AirlineShowAll = () => {
    ...
    return (
        ...
        {!loading && airlines.length > 0 && (
                        ...
                        {airlines.map((airline:Airline, index) => (
                            ...
                            <TableRow key={airline.id}>
                                ...
                                <TableCell align="right">
										...
										<IconButton component={Link} sx={{ mr: 3 }} to={`../update-airline/${airline.id}/`}>
											<EditIcon />
										</IconButton>

										<IconButton component={Link} sx={{ mr: 3 }} to={`../delete-airline/${airline.id}/`}>
            ...
            <Button disabled={airlines.length < pageSize} onClick={() => setPage(page + 1)}>Next</Button>
            </>
        )}
    </Container>
    );
